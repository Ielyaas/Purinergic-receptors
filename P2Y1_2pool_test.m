...
param.Vplc = 0.2; param.Kplc = 0.2; param.Vpkc = 0.2;
param.Kpkc = 0.3;
...
param.lambda_1 = 100;               % Ktau
param.lambda_2 = 0.36;              % tau_max
param.lambda_3 = 1;                 % IP3 degradation
param.lambda_4 = 0;              % PKC-PLC interaction
param.lambda_5 = 10;                 % Influx PLC

%% ODE SOLVER

solver = @(x,t)Pur_rec(x,t,param);
opts = odeset('RelTol',1e-6,'AbsTol',1e-9);
[~,Y] = ode15s(solver,[0 5000],[1 1 0.0805296 3.861011 0.70395 0],opts);
