...
param.Vplc = 0.019; param.Kplc = 0.11; param.Vpkc = 0.1;
param.Kpkc = 0.3;
...
param.k_5P = 0.0001; param.k_3K = 0.05; param.K_3K = 0.3;
...
[~,Y] = ode15s(solver,[0 2000],[1 1 0.0805296 2.551011 0.70395 0],opts);
[T,Y] = ode113(solver,[0 50],Y(end,:),opts);
...
tau = tau_max_til*param.Ktau^4./(c.^4 + param.Ktau^4);
