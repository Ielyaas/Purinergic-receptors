...
param.Vplc = 0.0165; param.Kplc = 0.11; param.Vpkc = 0.05;
param.Kpkc = 0.2;
...
[~,Y] = ode15s(solver,[0 1500],[1 1 0.0805296 3.861011 0.70395 0],opts);
...
kr = ((R1*param.A1/(param.K1 + param.A1)) + ...
     (R2*param.A2/(param.K2 + param.A2))).*...
     (param.Vplc + param.lambda_3).*(c.^2./(c.^2 + param.Kplc^2));
